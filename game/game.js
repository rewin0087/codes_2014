...
BasicGame.Game.prototype = { 
  ...
  update: function () {
    ...
    // bullets shot to enemy and player
    for (var i = 0; i < 2; i++) {
    ...
    // player movements collide on edge
    this.game.physics.enable(this.player, Phaser.Physics.ARCADE);
    this.player.body.collideWorldBounds = true;
    this.player.body.setSize(20, 20, 0, -5);
  ...
  checkWave: function () {
    ...
    } else if (this.wave === 2 && this.score >= 5000) {
      this.wave = 3;
      this.spawnRate = [600, 2000];
    } else if (this.wave === 3 && this.score >= 6000) {
      this.wave = 4;
  ...
  enemyFire: function() {
    ...
    if (this.boss && this.boss.alive && this.boss.form === 2 &&
      ...
      this.spawnEnemyBullet(this.boss.x + 20, this.boss.y + 20);
      this.boss.nextFire = this.time.now + 500;
    }
  },
